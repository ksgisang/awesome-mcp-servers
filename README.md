...
- <img src="https://ai-watch-tester.vercel.app/favicon.ico" height="14"/> [AWT (AI Watch Tester)](https://github.com/ksgisang/AI-Watch-Tester) - AI-powered E2E testing MCP server. Point at a URL — AI generates test scenarios, runs them with Playwright, and self-heals failures automatically. Works on Canvas and Flutter Web apps.
